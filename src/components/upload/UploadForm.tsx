...
const UploadForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const thumbnailFile = (e.currentTarget.thumbnail as HTMLInputElement).files?.[0];
  ...
  return (
    ...
    >
      ...
      {/* Thumbnail Upload */}
      <div>
        <label htmlFor="thumbnail" className="block font-medium mb-1">Upload Thumbnail</label>
        <input
          type="file"
          id="thumbnail"
          name="thumbnail"
